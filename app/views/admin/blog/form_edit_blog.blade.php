                      ...
                      <div id="stripedTable" class="table-responsive body collapse in">
                            ...
                            {{ Form::open(array('url' => '/admin/blog/modify/'.$blog->id, 'files' => true, 'class' => 'form-horizontal', 'id' => 'popup-validation', 'method' => 'post')) }}
                              <div class="form-group">
                                    ...
                                    <div class="col-lg-6">
                                        <select name="category" id="list-category" class="validate[required] form-control">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="text" class="validate[required] form-control" name="title" id="req" value="{{$blog->title}}">
                                        @if($errors->has('title'))
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-6">
                                        <textarea id="text4" name="resume" class="form-control">{{$blog->resume}}</textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class=" col-lg-6">
                                        <input value="{{$blog->date}}" class="validate[required,custom[date]] form-control" type="text"
                                               name="date" id="date3" />
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="checkbox">
                                    ...
                                    @else
                                      <label>
                                          <input class="uniform" type="radio" name="optionsRadios" value="1">Yes
                                      </label>
                                      <label>
                                          <input class="uniform" type="radio" name="optionsRadios" value="0" checked>No
                                      </label>
                                    @endif  
                                  </div>
                                </div>
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-lg-6">
                                      ...
                                      <div class="body">
                                         <textarea id="ckeditor" name="description" class="ckeditor">{{$blog->description}}</textarea>
                                ...
                                <div class="form-actions no-margin-bottom" style="text-align: right">
                                    ...
                                    <input type="button" onclick="window.open('<?=URL::to("/admin/blog/list")?>','_top');" value="Cancel" class="btn btn-metis-1 btn-lg btn-grad btn-rect">
                                </div>
                            {{ Form::close() }}
                        </div>
                      </div>
