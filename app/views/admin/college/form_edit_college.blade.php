                ...
                <div class="col-lg-12">
                  <div class="box">
                      ...
                      <div id="stripedTable" class="table-responsive body collapse in">
                            ...
                            {{ Form::open(array('url' => '/admin/college/modify/'.$college->id, 'files' => true, 'class' => 'form-horizontal', 'id' => 'popup-validation', 'method' => 'post')) }}
                              
                                <div class="form-group">
                                    <label class="control-label col-lg-3">Name</label>
                                    <div class="col-lg-6">
                                        <input type="text" class="validate[required] form-control" name="name" id="req" value="{{$college->name}}">
                                    </div>
                                </div>
                                ...
                                <div class="form-actions no-margin-bottom" style="text-align: right">
                                    ...
                                    <input type="button" onclick="window.open('<?=URL::to("/admin/college/list")?>','_top');" value="Cancel" class="btn btn-metis-1 btn-lg btn-grad btn-rect">
                                </div>
                            {{Form::close()}}
                        </div>
                      </div>
